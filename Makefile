...
CPP=g++
CPPFLAGS= $(CFLAGS)
CPPFLAGS+= -std=c++11 -Xlinker --unresolved-symbols=ignore-in-shared-libs
CPPDEPS= $(wildcard src/*.h)
CPPDEPS+= $(wildcard src/*.hpp) Makefile include/darknet.h
$(OBJDIR)%.o: %.cpp $(CPPDEPS)
